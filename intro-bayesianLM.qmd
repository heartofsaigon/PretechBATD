---
title: "Using Bayesian Linear Regression with Clinical Data"
subtitle: |
date: '`r Sys.Date()`'
author: Nam-Anh Tran
format:
...
knitr::include_graphics("images/intro-bayesianLM01.png")
```
...
dat <- read_csv(file = "data/ern_anxiety_data.csv")
